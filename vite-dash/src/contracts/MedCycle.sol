...
///////Following function is yet to be tested
    ...
    function medicineReceivedAtRetailer(address _batchId,address _distributorAddress) public{
        require(roles(Admin(admin).getRole(msg.sender))==roles.retailer,"Only retailer can access this function");
    ...
    function updateSaleStatus(
        ...
        require(roles(Admin(admin).getRole(msg.sender))==roles.retailer,"Only retailer can update status!");
    ...
    function getBatchesCountRetailer(address _retailer) public view returns(uint){
        require(roles(Admin(admin).getRole(_retailer))==roles.retailer,"Only retailer can call this function!");
