...
contract Admin{
    ...
    modifier onlyOwner(){
        require(msg.sender==owner,"sorry!,Only owner is allowed to visit!");
        _;
    }
    ...
    function registerUser(address EthAddress,string memory Name,string memory Location,uint Role) public {
